#
#....Implementation of Continuous Optimization of Oblique Splits (CO2)........
#
...
class CO2Node:
    ...
    def get_child(self, datum):
        ...
        X = deepcopy(datum)
        #X = np.hstack([X, 1])  # Augment the examples with a vector of ones
        ...
        if self._terminate(X, y, cur_depth):
            ...
            while not converged:
                ...
                for t in range(1, (self.tau + 1)):
                    sample = np.random.choice(n_samples, size=1)
